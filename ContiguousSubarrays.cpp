...
class Solution {
private:
    vector<int> contiguousSubarraysCount;
public:
...
vector<int> Solution::CountSubarrays(vector<int>& arr) {
    ...
    return contiguousSubarraysCount; // Return contiguousSubarraysCount where each index i contains an integer denoting the maximum number of contiguous subarrays of arr[i]
}
